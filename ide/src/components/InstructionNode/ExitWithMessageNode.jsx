...
function ExitWithMessageNodeComponent({ data }) {
  return (
...
export default memo(({ data, isConnectable }) => {
  return (
    <BaseInstructionNode data={data} isConnectable={isConnectable} specificNodeComponent={ExitWithMessageNodeComponent} />
  );
});
