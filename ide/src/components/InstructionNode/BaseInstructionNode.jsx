...
export default memo(({ data, isConnectable, specificNodeComponent }) => {
  return (
    <div style={{ height: `${data.height - 10}px`, padding: '2px', width: '100%', border: '2px black dashed', marginTop: '11px', marginBottom: '11px' }}>
      <div key={data.id}>
        <div className='instruction-node-content' style={{ width: '100%' }}>
          <Tooltip title={data.description}>
            ...
            <Paper elevation={3} style={{ backgroundColor: data.color, borderRadius: '1px', border: '1px solid black', paddingTop: '0', marginTop: '0', height: `${data.height - 20}px`, overflow: 'scroll', width: '100%' }}>
